...
Citizen.CreateThread(function()
    CoralSelling = AddBlipForCoord(-1684.965, -1068.42, 13.152173, 251.20416) 
    SetBlipSprite (CoralSelling, 537)
    SetBlipDisplay(CoralSelling, 4)
    SetBlipScale  (CoralSelling, 0.5)
    SetBlipAsShortRange(CoralSelling, true)
    SetBlipColour(CoralSelling, 5)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("Coral Selling")
    EndTextCommandSetBlipName(CoralSelling)
end) 
